package com.example.securitypart3.config.security.filters;

import com.example.securitypart3.config.security.authentication.CustomAuthentication;
import com.example.securitypart3.config.security.managers.CustomAuthenticationManager;
...
public class CustomAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        //1 create an authentication object with is not yet authenticated
        //2 delegate the authentication object to the manager
        //3 get back the authentication from the manager
        //4 if the object is authenticated then send request to the next filter to the chain
        ...
        if (a.isAuthenticated()) {
            SecurityContextHolder.getContext().setAuthentication(a);//who authenticated
        }
